 ...
 * TICKER
 * --------------------------------------------------------------------------------------
 */S,A={autoSleep:120,force3D:"auto",nullTargetWarn:1,units:{lineHeight:""}},L={duration:.5,overwrite:!1,delay:0},D=2*Math.PI,O=D/4,N=0,z=Math.sqrt,B=Math.cos,F=Math.sin,I=function(t){return"string"==typeof t},$=function(t){return"function"==typeof t},j=function(t){return"number"==typeof t},U=function(t){return void 0===t},W=function(t){return"object"==typeof t},q=function(t){return!1!==t},V=function(){return"undefined"!=typeof window},G=function(t){return $(t)||I(t)},X="function"==typeof ArrayBuffer&&ArrayBuffer.isView||function(){},Y=Array.isArray,H=/(?:-?\.?\d|\.)+/gi,Q=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,J=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,Z=/[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi,K=/[+-]=-?[.\d]+/,tt=/[^,'"\[\]\s]+/gi,te=/^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i,tr={},tn={},ti=function(t){return(tn=tL(t,tr))&&rb},ts=function(t,e){return console.warn("Invalid property",t,"set to",e,"Missing plugin? gsap.registerPlugin()")},ta=function(t,e){return!e&&console.warn(t)},to=function(t,e){return t&&(tr[t]=e)&&tn&&(tn[t]=e)||tr},tu=function(){return 0},th={suppressEvents:!0,isStart:!0,kill:!1},tl={suppressEvents:!0,kill:!1},tf={suppressEvents:!0},tc={},tp=[],td={},t_={},tg={},tm=30,tv=[],ty="",tw=function(t){var e,r,n=t[0];if(W(n)||$(n)||(t=[t]),!(e=(n._gsap||{}).harness)){for(// find the first target with a harness. We assume targets passed into an animation will be of similar type, meaning the same kind of harness can be used for them all (performance optimization)
...
e._dirty=1,e.totalDuration(),e=e.parent;return t},tU=function(t,e,r,n){return t._startAt&&(T?t._startAt.revert(tl):t.vars.immediateRender&&!t.vars.autoRevert||t._startAt.render(e,!0,n))},tW=function(t){return t._repeat?tq(t._tTime,t=t.duration()+t._rDelay)*t:0},tq=function(t,e){var r=Math.floor(t/=e);return t&&r===t?r-1:r},tV=function(t,e){return(t-e._start)*e._ts+(e._ts>=0?0:e._dirty?e.totalDuration():e._tDur)},tG=function(t){return t._end=tC(t._start+(t._tDur/Math.abs(t._ts||t._rts||1e-8)||0))},tX=function(t,e){// adjusts the animation's _start and _end according to the provided totalTime (only if the parent's smoothChildTiming is true and the animation isn't paused). It doesn't do any rendering or forcing things back into parent timelines, etc. - that's what totalTime() is for.
var r=t._dp;return r&&r.smoothChildTiming&&t._ts&&(t._start=tC(r._time-(t._ts>0?e/t._ts:-(((t._dirty?t.totalDuration():t._tDur)-e)/t._ts))),tG(t),r._dirty||t$(r,t)),t},/*
...
r=tV(t.rawTime(),e),(!e._dur||t9(0,e.totalDuration(),r)-e._tTime>1e-8)&&e.render(r,!0)),t$(t,e)._dp&&t._initted&&t._time>=t._dur&&t._ts){//in case any of the ancestors had completed but should now be enabled...
...
}},tH=function(t,e,r,n){return e.parent&&tI(e),e._start=tC((j(r)?r:r||t!==b?t8(t,r,e):t._time)+e._delay),e._end=tC(e._start+(e.totalDuration()/Math.abs(e.timeScale())||0)),tB(t,e,"_first","_last",t._sort?"_start":0),tK(e)||(t._recent=e),n||tY(t,e),t._ts<0&&tX(t,t._tTime),t},tQ=function(t,e){return(tr.ScrollTrigger||ts("scrollTrigger",e))&&tr.ScrollTrigger.create(e,t)},tJ=function(t,e,r,n,i){return(eZ(t,e,i),t._initted)?!r&&t._pt&&!T&&(t._dur&&!1!==t.vars.lazy||!t._dur&&t.vars.lazy)&&E!==eC.frame?(tp.push(t),t._lazy=[i,n],1):void 0:1},tZ=function t(e){var r=e.parent;return r&&r._ts&&r._initted&&!r._lock&&(0>r.rawTime()||t(r))},tK=function(t){var e=t.data;return"isFromStart"===e||"isStart"===e},t0=function(t,e,r,n){var i,s,a,o=t.ratio,u=e<0||!e&&(!t._start&&tZ(t)&&!(!t._initted&&tK(t))||(t._ts<0||t._dp._ts<0)&&!tK(t))?0:1,h=t._rDelay,l=0;if(h&&t._repeat&&(s=tq(// in case there's a zero-duration tween that has a repeat with a repeatDelay
l=t9(0,t._tDur,e),h),t._yoyo&&1&s&&(u=1-u),s!==tq(t._tTime,h)&&(// if iteration changed
o=1-u,t.vars.repeatRefresh&&t._initted&&t.invalidate())),u!==o||T||n||1e-8===t._zTime||!e&&t._zTime){if(!t._initted&&tJ(t,e,n,r,l))return;for(a=t._zTime,t._zTime=e||(r?1e-8:0),r||(r=e&&!a),t.ratio=u,t._from&&(u=1-u),t._time=0,t._tTime=l,i=t._pt;i;)i.r(u,i.d),i=i._next;e<0&&tU(t,e,r,!0),t._onUpdate&&!r&&ep(t,"onUpdate"),l&&t._repeat&&!r&&t.parent&&ep(t,"onRepeat"),(e>=t._tDur||e<0)&&t.ratio===u&&(u&&tI(t,1),r||T||(ep(t,u?"onComplete":"onReverseComplete",!0),t._prom&&t._prom()))}else t._zTime||(t._zTime=e)},t1=function(t,e,r){var n;if(r>e)for(n=t._first;n&&n._start<=r;){if("isPause"===n.data&&n._start>e)return n;n=n._next}else for(n=t._last;n&&n._start>=r;){if("isPause"===n.data&&n._start<e)return n;n=n._prev}},t2=function(t,e,r,n){var i=t._repeat,s=tC(e)||0,a=t._tTime/t._tDur;return a&&!n&&(t._time*=s/t._dur),t._dur=s,t._tDur=i?i<0?1e10:tC(s*(i+1)+t._rDelay*i):s,a>0&&!n&&tX(t,t._tTime=t._tDur*a),t.parent&&tG(t),r||t$(t.parent,t),t},t5=function(t){return t instanceof ej?t$(t):t2(t,t._dur)},t3={_start:0,endTime:tu,totalDuration:tu},t8=function t(e,r,n){var i,s,a,o=e.labels,u=e._recent||t3,h=e.duration()>=1e8?u.endTime(!1):e._dur;return I(r)&&(isNaN(r)||r in o)?(//if the string is a number like "1", check to see if there's a label with that name, otherwise interpret it as a number (absolute value).
...
var e=[],r=[],n=-1;return t.split(ex).forEach(function(t){var i=t.match(J)||[];e.push.apply(e,i),r.push(n+=i.length+1)}),e.c=r,e},eT=function(t,e,r){var n,i,s,a,o="",u=(t+o).match(ex),h=e?"hsla(":"rgba(",l=0;if(!u)return t;if(u=u.map(function(t){return(t=ey(t,e,1))&&h+(e?t[0]+","+t[1]+"%,"+t[2]+"%,"+t[3]:t.join(","))+")"}),r&&(s=ew(t),(n=r.c).join(o)!==s.c.join(o)))for(a=(i=t.replace(ex,"1").split(J)).length-1;l<a;l++)o+=i[l]+(~n.indexOf(l)?u.shift()||h+"0,0,0,0)":(s.length?s:u.length?u:r).shift());if(!i)for(a=(i=t.split(ex)).length-1;l<a;l++)o+=i[l]+u[l];return o+i[a]},ex=function(){var t,e="(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b";for(t in em)e+="|"+t+"\\b";return RegExp(e+")","gi")}(),eb=/hsl[a]?\(/,eC=(f=Date.now,c=500,p=33,_=d=f(),g=1e3/240,m=1e3/240,v=[],y=function t(e){var r,n,i,o,y=f()-_,w=!0===e;if(y>c&&(d+=y-p),_+=y,((r=(i=_-d)-m)>0||w)&&(o=++u.frame,h=i-1e3*u.time,u.time=i/=1e3,m+=r+(r>=g?4:g-r),n=1),w||(s=a(t)),n)for(l=0;l<v.length;l++)v[l](i,h,o,e)},u={time:0,frame:0,tick:function(){y(!0)},deltaRatio:function(t){return h/(1e3/(t||60))},wake:function(){k&&(!P&&V()&&(M=(C=P=window).document||{},tr.gsap=rb,(C.gsapVersions||(C.gsapVersions=[])).push(rb.version),ti(tn||C.GreenSockGlobals||!C.gsap&&C||{}),o=C.requestAnimationFrame,e_.forEach(eg)),s&&u.sleep(),a=o||function(t){return setTimeout(t,m-1e3*u.time+1|0)},S=1,y(2))},sleep:function(){(o?C.cancelAnimationFrame:clearTimeout)(s),S=0,a=tu},lagSmoothing:function(t,e){p=Math.min(e||33,c=t||1/0)},fps:function(t){g=1e3/(t||240),m=1e3*u.time+g},add:function(t,e,r){var n=e?function(e,r,i,s){t(e,r,i,s),u.remove(n)}:t;return u.remove(t),v[r?"unshift":"push"](n),eP(),n},remove:function(t,e){~(e=v.indexOf(t))&&v.splice(e,1)&&l>=e&&l--},_listeners:v}),eP=function(){return!S&&eC.wake()},/*
* -------------------------------------------------
* EASING
* -------------------------------------------------
...
var e=(t+"").split("("),r=eM[e[0]];return r&&e.length>1&&r.config?r.config.apply(null,~t.indexOf("{")?[eR(e[1])]:eS(t).split(",").map(tR)):eM._CE&&ek.test(t)?eM._CE("",t):r},eL=function(t){return function(e){return 1-t(1-e)}},eD=function t(e,r){for(var n,i=e._first;i;)i instanceof ej?t(i,r):!i.vars.yoyoEase||i._yoyo&&i._repeat||i._yoyo===r||(i.timeline?t(i.timeline,r):(n=i._ease,i._ease=i._yEase,i._yEase=n,i._yoyo=r)),i=i._next},eO=function(t,e){return t&&($(t)?t:eM[t]||eA(t))||e},eN=function(t,e,r,n){void 0===r&&(r=function(t){return 1-e(1-t)}),void 0===n&&(n=function(t){return t<.5?e(2*t)/2:1-e((1-t)*2)/2});var i,s={easeIn:e,easeOut:r,easeInOut:n};return tb(t,function(t){for(var e in eM[t]=tr[t]=s,eM[i=t.toLowerCase()]=r,s)eM[i+("easeIn"===e?".in":"easeOut"===e?".out":".inOut")]=eM[t+"."+e]=s[e]}),s},ez=function(t){return function(e){return e<.5?(1-t(1-2*e))/2:.5+t((e-.5)*2)/2}},eB=function t(e,r,n){var i=r>=1?r:1,s=(n||(e?.3:.45))/(r<1?r:1),a=s/D*(Math.asin(1/i)||0),o=function(t){return 1===t?1:i*Math.pow(2,-10*t)*F((t-a)*s)+1},u="out"===e?o:"in"===e?function(t){return 1-o(1-t)}:ez(o);return s=D/s,u.config=function(r,n){return t(e,r,n)},u},eF=function t(e,r){void 0===r&&(r=1.70158);var n=function(t){return t?--t*t*((r+1)*t+r)+1:0},i="out"===e?n:"in"===e?function(t){return 1-n(1-t)}:ez(n);return i.config=function(r){return t(e,r)},i};// a cheaper (kb and cpu) but more mild way to get a parameterized weighted ease by feeding in a value between -1 (easeIn) and 1 (easeOut) where 0 is linear.
// _weightedEase = ratio => {
// 	let y = 0.5 + ratio / 2;
...
},e.totalProgress=function(t,e){return arguments.length?this.totalTime(this.totalDuration()*t,e):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.ratio},e.progress=function(t,e){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(1&this.iteration())?1-t:t)+tW(this),e):this.duration()?Math.min(1,this._time/this._dur):this.ratio},e.iteration=function(t,e){var r=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(t-1)*r,e):this._repeat?tq(this._tTime,r)+1:1}// potential future addition:
...
this._start=f,tG(this),this.render(t,e,r));this._onUpdate&&!e&&ep(this,"onUpdate",!0),(v===g&&this._tTime>=this.totalDuration()||!v&&_)&&(f===this._start||Math.abs(l)!==Math.abs(this._ts))&&!this._lock&&(// remember, a child's callback may alter this timeline's playhead or timeScale which is why we need to add some of these checks.
...
i-=r,(!n&&!this._dp||n&&n.smoothChildTiming)&&(this._start+=r/this._ts,this._time-=r,this._tTime-=r),this.shiftChildren(-r,!1,-1/0),a=0),s._end>i&&s._ts&&(i=s._end),s=e;t2(this,this===b&&this._time>i?this._time:i,1,1),this._dirty=0}return this._tDur},e.updateRoot=function(t){if(b._ts&&(tE(b,tV(t,b)),E=eC.frame),eC.frame>=tm){tm+=A.autoSleep||120;var e=b._first;if((!e||!e._ts)&&A.autoSleep&&eC._listeners.length<2){for(;e&&!e._ts;)e=e._next;e||eC.sleep()}}},e}(e$);tA(ej.prototype,{_lock:0,_hasPause:0,_forcing:0});var eU,eW,eq,eV,eG,eX,eY=function(t,e,r,n,i,s,a){//note: we call _addComplexStringPropTween.call(tweenInstance...) to ensure that it's scoped properly. We may call it from within a plugin too, thus "this" would refer to the plugin.
var o,u,h,l,f,c,p,d,_=new rh(this._pt,t,e,0,1,rn,null,i),g=0,m=0;for(_.b=r,_.e=n,r+="",n+="",(p=~n.indexOf("random("))&&(n=el(n)),s&&(s(d=[r,n],t,e),r=d[0],n=d[1]),u=r.match(Z)||[];o=Z.exec(n);)l=o[0],f=n.substring(g,o.index),h?h=(h+1)%5:"rgba("===f.substr(-5)&&(h=1),l!==u[m++]&&(c=parseFloat(u[m-1])||0,_._pt={_next:_._pt,p:f||1===m?f:",",//note: SVG spec allows omission of comma/space when a negative sign is wedged between two numbers, like 2.5-5.3 instead of 2.5,-5.3 but when tweening, the negative value may switch to positive, so we insert the comma just in case.
s:c,c:"="===l.charAt(1)?tP(c,l)-c:parseFloat(l)-c,m:h&&h<4?Math.round:0},g=Z.lastIndex);return _.c=g<n.length?n.substring(g,n.length):"",_.fp=a,(K.test(n)||p)&&(_.e=0),this._pt=_,_},eH=function(t,e,r,n,i,s,a,o,u,h){$(n)&&(n=n(i||0,t,s));var l,f=t[e],c="get"!==r?r:$(f)?u?t[e.indexOf("set")||!$(t["get"+e.substr(3)])?e:"get"+e.substr(3)](u):t[e]():f,p=$(f)?u?e9:e6:e4;if(I(n)&&(~n.indexOf("random(")&&(n=el(n)),"="===n.charAt(1)&&((l=tP(c,n)+(t7(c)||0))||0===l)&&(n=l)),!h||c!==n||eX)return isNaN(c*n)||""===n?(f||e in t||ts(e,n),eY.call(this,t,e,c,n,p,o||A.stringFilter,u)):(// fun fact: any number multiplied by "" is evaluated as the number 0!
l=new rh(this._pt,t,e,+c||0,n-(c||0),"boolean"==typeof f?rr:re,0,p),u&&(l.fp=u),a&&l.modifier(a,this,t),this._pt=l)},eQ=function(t,e,r,n,i){if($(t)&&(t=e2(t,i,e,r,n)),!W(t)||t.style&&t.nodeType||Y(t)||X(t))return I(t)?e2(t,i,e,r,n):t;var s,a={};for(s in t)a[s]=e2(t[s],i,e,r,n);return a},eJ=function(t,e,r,n,i,s){var a,o,u,h;if(t_[t]&&!1!==(a=new t_[t]).init(i,a.rawVars?e[t]:eQ(e[t],n,i,s,r),r,n,s)&&(r._pt=o=new rh(r._pt,i,t,0,1,a.render,a,0,a.priority),r!==R))for(u=r._ptLookup[r._targets.indexOf(i)],h=a._props.length;h--;)u[a._props[h]]=o;return a},eZ=function t(e,r,n){var i,s,a,o,u,h,l,f,c,p,d,_,g,m=e.vars,v=m.ease,y=m.startAt,x=m.immediateRender,C=m.lazy,P=m.onUpdate,M=m.onUpdateParams,k=m.callbackScope,E=m.runBackwards,R=m.yoyoEase,S=m.keyframes,A=m.autoRevert,D=e._dur,O=e._startAt,N=e._targets,z=e.parent,B=z&&"nested"===z.data?z.vars.targets:N,F="auto"===e._overwrite&&!w,I=e.timeline;if(!I||S&&v||(v="none"),e._ease=eO(v,L.ease),e._yEase=R?eL(eO(!0===R?v:R,L.ease)):0,R&&e._yoyo&&!e._repeat&&(//there must have been a parent timeline with yoyo:true that is currently in its yoyo phase, so flip the eases.
...
O._lazy=0),y){if(tI(e._startAt=e8.set(N,tA({data:"isStart",overwrite:!1,parent:z,immediateRender:!0,lazy:!O&&q(C),startAt:null,delay:0,onUpdate:P,onUpdateParams:M,callbackScope:k,stagger:0},y))),e._startAt._dp=0,e._startAt._sat=e,r<0&&(T||!x&&!A)&&e._startAt.revert(tl),x&&D&&r<=0&&n<=0){// check tTime here because in the case of a yoyo tween whose playhead gets pushed to the end like tween.progress(1), we should allow it through so that the onComplete gets fired properly.
...
}}else if(E&&D&&!O){if(r&&(x=!1),a=tA({overwrite:!1,data:"isFromStart",//we tag the tween with as "isFromStart" so that if [inside a plugin] we need to only do something at the very END of a tween, we have a way of identifying this tween as merely the one that's setting the beginning values for a "from()" tween. For example, clearProps in CSSPlugin should only get applied at the very END of a tween and without this tag, from(...{height:100, clearProps:"height", delay:1}) would wipe the height at the beginning of the tween and after 1 second, it'd kick back in.
lazy:x&&!O&&q(C),immediateRender:x,//zero-duration tweens render immediately by default, but if we're not specifically instructed to render this tween immediately, we should skip this and merely _init() to record the starting values (rendering them immediately would push them to completion which is wasteful in that case - we'd have to render(-1) immediately after)
...
}for(s=0,e._pt=e._ptCache=0,C=D&&q(C)||C&&!D;s<N.length;s++){if(l=(u=N[s])._gsap||tw(N)[s]._gsap,e._ptLookup[s]=p={},td[l.id]&&tp.length&&tk(),d=B===N?s:B.indexOf(u),f&&!1!==(c=new f).init(u,_||i,e,d,B)&&(e._pt=o=new rh(e._pt,u,c.name,0,1,c.render,c,0,c.priority),c._props.forEach(function(t){p[t]=o}),c.priority&&(h=1)),!f||_)for(a in i)t_[a]&&(c=eJ(a,i,e,d,u,B))?c.priority&&(h=1):p[a]=o=eH.call(e,u,a,"get",i[a],d,B,0,m.stringFilter);e._op&&e._op[s]&&e.kill(u,e._op[s]),F&&e._pt&&(eG=e,b.killTweensOf(u,p,e.globalTime(r)),g=!e.parent,eG=0),e._pt&&C&&(td[l.id]=1)}h&&ru(e),e._onInit&&e._onInit(e)}e._onUpdate=P,e._initted=(!e._op||e._pt)&&!g,S&&r<=0&&I.render(1e8,!0,!0)},eK=function(t,e,r,n,i,s,a){var o,u,h,l,f=(t._pt&&t._ptCache||(t._ptCache={}))[e];if(!f)for(f=t._ptCache[e]=[],h=t._ptLookup,l=t._targets.length;l--;){if((o=h[l][e])&&o.d&&o.d._pt)for(// it's a plugin, so find the nested PropTween
...
s=this._repeat,n=d):((s=~~(g/a))&&s===g/a&&(n=d,s--),n>d&&(n=d)),(u=this._yoyo&&1&s)&&(f=this._yEase,n=d-n),o=tq(this._tTime,a),n===c&&!r&&this._initted)return(//could be during the repeatDelay part. No need to render and fire callbacks.
this._tTime=g,this);s===o||(l&&this._yEase&&eD(l,u),!this.vars.repeatRefresh||u||this._lock||(this._lock=r=1,this.render(tC(a*s),!0).invalidate()._lock=0))}if(!this._initted){if(tJ(this,_?t:n,r,e,g))return this._tTime=0,this;if(c!==this._time)return this;if(d!==this._dur)return this.render(t,e,r)}if(this._tTime=g,this._time=n,!this._act&&this._ts&&(this._act=1,this._lazy=0),this.ratio=h=(f||this._ease)(n/d),this._from&&(this.ratio=h=1-h),n&&!c&&!e&&!s&&(ep(this,"onStart"),this._tTime!==g))return this;for(i=this._pt;i;)i.r(h,i.d),i=i._next;l&&l.render(t<0?t:!n&&u?-.00000001:l._dur*l._ease(n/this._dur),e,r)||this._startAt&&(this._zTime=t),this._onUpdate&&!e&&(_&&tU(this,t,e,r),ep(this,"onUpdate")),this._repeat&&s!==o&&this.vars.onRepeat&&!e&&this.parent&&ep(this,"onRepeat"),(g===this._tDur||!g)&&this._tTime===g&&(_&&!this._onUpdate&&tU(this,t,!0,!0),(t||!d)&&(g===this._tDur&&this._ts>0||!g&&this._ts<0)&&tI(this,1),!e&&!(_&&!c)&&(g||c||u)&&(// if prevTime and tTime are zero, we shouldn't fire the onReverseComplete. This could happen if you gsap.to(... {paused:true}).play();
...
// 	}
// } else {
(this._initted||eZ(this,i),eK(this,t,e,r,n,this._ease(i/this._dur),i))?this.resetTo(t,e,r,n):(//}
...
e8.version=ej.version=rb.version="3.12.2",k=1,V()&&eP(),eM.Power0,eM.Power1,eM.Power2,eM.Power3,eM.Power4,eM.Linear,eM.Quad,eM.Cubic,eM.Quart,eM.Quint,eM.Strong,eM.Elastic,eM.Back,eM.SteppedEase,eM.Bounce,eM.Sine,eM.Expo,eM.Circ}),s("lMtSn",function(e,r){t(e.exports,"MotionPathPlugin",function(){return P});/*!
 ...
 * Club GreenSock members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*//* eslint-disable */var n,s,a,o,u,h,l=i("aX3Yc"),f=i("iV99o"),c="x,translateX,left,marginLeft,xPercent".split(","),p="y,translateY,top,marginTop,yPercent".split(","),d=Math.PI/180,_=function(t,e,r,n){for(//mode: 0 = x but don't fill y yet, 1 = y, 2 = x and fill y with 0.
...
function A(t,e,r){var n,i=t[e],s=t[e+2],a=t[e+4];return i+=(s-i)*r,s+=(a-s)*r,i+=(s-i)*r,n=s+(a+(t[e+6]-a)*r-s)*r-i,i=t[e+1],s=t[e+3],a=t[e+5],i+=(s-i)*r,s+=(a-s)*r,i+=(s-i)*r,y(p(s+(a+(t[e+7]-a)*r-s)*r-i,n)*u)}function L(t,e,r){var n=Math.max(0,~~(f((r=void 0===r?1:w(r)||0)-(e=w(e)||0))-1e-8)),i=function(t){for(var e=[],r=0;r<t.length;r++)e[r]=C(t[r],t[r].slice(0));return C(t,e)}(t);if(e>r&&(e=1-e,r=1-r,b(i),i.totalLength=0),e<0||r<0){var s=Math.abs(~~Math.min(e,r))+1;e+=s,r+=s}i.totalLength||D(i);var a,o,u,h,l,c,p,d,_=r>1,v=N(i,e,g,!0),y=N(i,r,m),x=y.segment,M=v.segment,k=y.segIndex,E=v.segIndex,R=y.i,S=v.i,L=E===k,z=R===S&&L;if(_||n){for(a=k<E||L&&R<S||z&&y.t<v.t,T(i,E,S,v.t)&&(E++,!a&&(k++,z?(y.t=(y.t-v.t)/(1-v.t),R=0):L&&(R-=S))),1e-5>Math.abs(1-(r-e))?k=E-1:!y.t&&k?k--:T(i,k,R,y.t)&&a&&E++,1===v.t&&(E=(E+1)%i.length),l=[],p=1+(c=i.length)*n,d=E,p+=(c-E+k)%c,h=0;h<p;h++)P(l,i[d++%c]);i=l}else if(u=1===y.t?6:O(x,R,y.t),e!==r)for(o=O(M,S,z?v.t/y.t:v.t),L&&(u+=o),x.splice(R+u+2),(o||S)&&M.splice(0,S+o),h=i.length;h--;)(h<E||h>k)&&i.splice(h,1);else x.angle=A(x,R+u,0),R+=u,v=x[R],y=x[R+1],x.length=x.totalLength=0,x.totalPoints=i.totalPoints=8,x.push(v,y,v,y,v,y,v,y);return i.totalLength=0,i}//measures a Segment according to its resolution (so if segment.resolution is 6, for example, it'll take 6 samples equally across each Bezier) and create/populate a "samples" Array that has the length up to each of those sample points (always increasing from the start) as well as a "lookup" array that's broken up according to the smallest distance between 2 samples. This gives us a very fast way of looking up a progress position rather than looping through all the points/Beziers. You can optionally have it only measure a subset, starting at startIndex and going for a specific number of beziers (remember, there are 3 x/y pairs each, for a total of 6 elements for each Bezier). It will also populate a "totalLength" property, but that's not generally super accurate because by default it'll only take 6 samples per Bezier. But for performance reasons, it's perfectly adequate for measuring progress values along the path. If you need a more accurate totalLength, either increase the resolution or use the more advanced bezierToPoints() method which keeps adding points until they don't deviate by more than a certain precision value.
function D(t,e){var r,n,i;for(i=r=n=0;i<t.length;i++)t[i].resolution=~~e||12,n+=t[i].length,r+=function(t,e,r){e=e||0,t.samples||(t.samples=[],t.lookup=[]);var n,i,s,a,o,u,h,l,p,d,_,g,m,v,y,w,T,x=~~t.resolution||12,b=1/x,C=r?e+6*r+1:t.length,P=t[e],M=t[e+1],k=e?e/6*x:0,E=t.samples,R=t.lookup,S=(e?t.minLength:1e8)||1e8,A=E[k+r*x-1],L=e?E[k-1]:0;for(E.length=R.length=0,i=e+2;i<C;i+=6){if(s=t[i+4]-P,a=t[i+2]-P,o=t[i]-P,l=t[i+5]-M,p=t[i+3]-M,d=t[i+1]-M,u=h=_=g=0,.01>f(s)&&.01>f(l)&&f(o)+f(d)<.01)t.length>8&&(t.splice(i,6),i-=6,C-=6);else for(n=1;n<=x;n++)m=1-(v=b*n),u=h-(h=(v*v*s+3*m*(v*a+m*o))*v),(w=c((_=g-(g=(v*v*l+3*m*(v*p+m*d))*v))*_+u*u))<S&&(S=w),L+=w,E[k++]=L;P+=s,M+=l}if(A)for(A-=L;k<E.length;k++)E[k]+=A;if(E.length&&S){if(t.totalLength=T=E[E.length-1]||0,t.minLength=S,T/S<9999)for(n=0,// if the lookup would require too many values (memory problem), we skip this and instead we use a loop to lookup values directly in the samples Array
w=y=0;n<T;n+=S)R[w++]=E[y]<n?++y:y}else t.totalLength=E[0]=0;return e?L-E[e/2-1]:L}(t[i]);return t.totalPoints=n,t.totalLength=r,t}//divide segment[i] at position t (value between 0 and 1, progress along that particular cubic bezier segment that starts at segment[i]). Returns how many elements were spliced into the segment array (either 0 or 6)
...
A(P,M,P,M=i+(p?M-P:0)),e+=1;else if("L"===u||"Z"===u)"Z"===u&&(i=_,a=g,d.closed=!0),("L"===u||f(P-i)>.5||f(M-a)>.5)&&(A(P,M,i,a),"L"===u&&(e+=2)),P=i,M=a;else if("A"===u){if(T=b[e+4],x=b[e+5],m=b[e+6],v=b[e+7],r=7,T.length>1&&(T.length<3?(v=m,m=x,r--):(v=x,m=T.substr(2),r-=2),x=T.charAt(1),T=T.charAt(0)),y=function(t,e,r,n,i,s,a,u,p){if(t!==u||e!==p){r=f(r),n=f(n);var d=i%360*o,_=l(d),g=h(d),m=Math.PI,v=2*m,y=(t-u)/2,w=(e-p)/2,T=_*y+g*w,x=-g*y+_*w,b=T*T,C=x*x,P=b/(r*r)+C/(n*n);P>1&&(r=c(P)*r,n=c(P)*n);var M=r*r,k=n*n,E=(M*k-M*C-k*b)/(M*C+k*b);E<0&&(E=0);var R=(s===a?-1:1)*c(E),S=R*(r*x/n),A=-(R*(n*T/r)),L=(t+u)/2+(_*S-g*A),D=(e+p)/2+(g*S+_*A),O=(T-S)/r,N=(x-A)/n,z=(-T-S)/r,B=(-x-A)/n,F=O*O+N*N,I=(N<0?-1:1)*Math.acos(O/c(F)),$=(O*B-N*z<0?-1:1)*Math.acos((O*z+N*B)/c(F*(z*z+B*B)));isNaN($)&&($=m),!a&&$>0?$-=v:a&&$<0&&($+=v),I%=v;var j,U=Math.ceil(f($%=v)/(v/4)),W=[],q=$/U,V=4/3*h(q/2)/(1+l(q/2)),G=_*r,X=g*r,Y=-(g*n),H=_*n;for(j=0;j<U;j++)T=l(i=I+j*q),x=h(i),O=l(i+=q),N=h(i),W.push(T-V*x,x+V*T,O+V*N,N-V*O,O,N);//now transform according to the actual size of the ellipse/arc (the beziers were noramlized, between 0 and 1 on a circle).
for(j=0;j<W.length;j+=2)T=W[j],x=W[j+1],W[j]=T*G+x*Y+L,W[j+1]=T*X+x*H+D;return W[j-2]=u,W[j-1]=p,W}}//Spits back a RawPath with absolute coordinates. Each segment starts with a "moveTo" command (x coordinate, then y) and then 2 control points (x, y, x, y), then anchor. The goal is to minimize memory and maximize speed.
...
*/}),s("iV99o",function(e,r){t(e.exports,"getGlobalMatrix",function(){return P});/*!
 * matrix 3.12.2
 * https://greensock.com
 *
 * Copyright 2008-2023, GreenSock. All rights reserved.
...
return i(t)&&(e=/^(#[a-z]\w+)$/.test(t.trim())?document.getElementById(t.trim().slice(1)):document.querySelectorAll(t)),l(e).reduce((t,e)=>[...t,...l(e).filter(h)],[])}t(e.exports,"default",function(){return W}),/**
 * SplitType
 ...
 * Editors
 */let T="\ud800-\udfff",x="\\u0300-\\u036f\\ufe20-\\ufe23",b="\\u20d0-\\u20f0",C="\\ufe0e\\ufe0f",P=`[${T}]`,M=`[${x}${b}]`,k="\ud83c[\udffb-\udfff]",E=`(?:${M}|${k})`,R=`[^${T}]`,S="(?:\ud83c[\udde6-\uddff]){2}",A="[\ud800-\udbff][\udc00-\udfff]",L="\\u200d",D=`${E}?`,O=`[${C}]?`,N="(?:"+L+"(?:"+[R,S,A].join("|")+")"+O+D+")*",z=`(?:${[`${R}${M}?`,M,S,A,P].join("|")}
)`,B=RegExp(`${k}(?=${k})|${z}${O+D+N}`,"g"),F=RegExp(`[${[L,T,x,b,C].join("")}]`);/**
 ...
 */function I(t,e){let r=document.createElement(t);return e&&Object.keys(e).forEach(t=>{let n=e[t],s=i(n)?n.trim():n;null!==s&&""!==s&&("children"===t?r.append(...l(s)):r.setAttribute(t,s))}),r}var $={splitClass:"",lineClass:"line",wordClass:"word",charClass:"char",types:["lines","words","chars"],absolute:!1,tagName:"div"};let j=()=>document.createDocumentFragment(),U=n($,{});class W{/**
   ...
   * @static
   */static create(t,e){return new W(t,e)}/**
   * Creates a new `SplitType` instance
   *
...
this.lines=null,this.words=null,this.chars=null,this.isSplit=!1),W.revert(this.elements)}}}),i("47X9g")}();//# sourceMappingURL=index.931ef553.js.map

//# sourceMappingURL=index.931ef553.js.map
